...
/**
* <p>Title: CatMybatisPlugins</p>  
* <p>Description: 定义CAT-mybatis拦截器，实现埋点 </p>  
* @author zhulin
* @date 2019年4月16日
 */
@Intercepts({
...
public class CatMybatisPlugins implements Interceptor {
    ...
    private static Log logger = LogFactory.getLog(CatMybatisPlugins.class);
...
//        String dbName = RouteDataSourceContext.getRouteKey();
        ...
        String url = CatMybatisPlugins.sqlURLCache.get(dbName);
        if (url != null) {
            return url;
        }
        ...
        CatMybatisPlugins.sqlURLCache.put(dbName, url);
        return url;
    }
