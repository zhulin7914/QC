...
<head>
    <meta charset="utf-8">
    <title>团体保单查询</title>
	<script src="/static/js/demo/lcgrpcont.js"></script>
</head>
<body>
...
<form class="layui-form layui-form-pane" action="" style="margin-left: 50px;" lay-filter="example">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 100px;">
                <input type="text" name="signdate" id="date3"  placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid">-</div>
            <div class="layui-input-inline" style="width: 100px;">
                <input type="text" name="signdate" id="date4"  placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
            </div>
    ...
    <div class="layui-form-item">
        <button class="layui-btn" lay-submit="" lay-filter="demo1" id="demo1">查询</button>
